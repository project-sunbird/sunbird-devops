...
*/}}
{{- define "kafka-lag-exporter.name" -}}
...
*/}}
{{- define "kafka-lag-exporter.fullname" -}}
...
*/}}
{{- define "kafka-lag-exporter.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "kafka-lag-exporter.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
