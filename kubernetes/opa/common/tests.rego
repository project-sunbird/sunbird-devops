...
test_main_check_if_consumer_is_skipped {
    data.main.allow.allowed
    with input as
    {
      "attributes": {
...
test_main_not_identified_action {
    data.main.allow.allowed
    with input as
    {
      "attributes": {
...
test_common_public_role_check_with_for_token {
    data.main.allow.allowed
    with input as
    {
      "attributes": {
...
test_common_public_role_check_with_empty_for_token {
    data.main.allow.allowed
    with input as
    {
      "attributes": {
...
test_common_public_role_check_with_keycloak_token {
    data.main.allow.allowed
    with input as
    {
      "attributes": {
