                    ...
                    <div class="field">
                        <div>
                            ...
                            <#if realm.resetPasswordAllowed>
                                <div id="versionLink" class="ui right floated forgetPasswordLink" tabindex="1" onclick="javascript:redirect('/recover/identify/account');javascript:makeDivUnclickable()">${msg("doForgotPassword")}</div>
                            </#if>
