...
check_version() {
	list=(actor-service player_player user-org-service content-service proxy_proxy api-manager_kong)
...
get_logs() {
	...
	echo "-----------------------------------------"
	serviceNames=(player_player user-org-service content-service proxy_proxy api-manager_kong)
