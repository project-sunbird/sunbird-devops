    ...
    try {
        ansiColor('xterm') {
            ...
            stage('ansible-run') {
                ...
                sh """
                        cp --preserve=links -rf ${pipelineParams.currentWs}/private/ansible/inventory/${pipelineParams.env}/${pipelineParams.module}/* ${pipelineParams.currentWs}/ansible/inventory/env/
