...
ansible-playbook --limit 172.16.0.5 -i ansible/inventories/$ENV sunbird-devops/ansible/createuser.yml --tags "add-user" --extra-vars="remote=172.16.0.5 group=$2 user=$2 password=$pass public_key=$4" --vault-password-file /run/secrets/vault-pass
